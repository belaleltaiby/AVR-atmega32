 ...
 * SPI_Porting.h
 *
 * Created: 11/3/2023 10:54:10 AM
 *  Author: Belal
 */ 


#ifndef SPI_PORTING_H_
#define SPI_PORTING_H_
#include "Types.h"

#define SPCR	*((uint8*)0x2D)
#define SPSR	*((uint8*)0x2E)
#define SPDR	*((uint8*)0x2F)
